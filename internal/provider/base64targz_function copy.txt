...
var _ function.Function = &TarFunction{}

type TarFunction struct{}
...
func NewTarFunction() function.Function {
	return &TarFunction{}
}

func (f *TarFunction) Metadata(ctx context.Context, req function.MetadataRequest, resp *function.MetadataResponse) {
	resp.Name = "base64targz"
}

func (f *TarFunction) Definition(ctx context.Context, req function.DefinitionRequest, resp *function.DefinitionResponse) {
...
func (f *TarFunction) Run(ctx context.Context, req function.RunRequest, resp *function.RunResponse) {
	var sources []Source
